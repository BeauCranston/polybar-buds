...
export BT_HEADSET_NAME=

#run bluetoothctl devices Connected to get a list of devices. Grab the mac address of your device and paste it to the field below
